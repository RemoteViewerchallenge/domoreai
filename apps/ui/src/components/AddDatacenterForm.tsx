...
interface AddDatacenterFormProps {
  onSuccess?: () => void;
  onCancel?: () => void;
  customMutation?: {
...
export const AddDatacenterForm: React.FC<AddDatacenterFormProps> = ({ onSuccess, onCancel, customMutation }) => {
