        ...
        <div className="space-y-6 p-4 bg-[var(--bg-primary)] rounded border border-[var(--border-color)]">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <button
                        onClick={() => onChange({ temperature: 0.7, topP: 1.0, frequencyPenalty: 0.0, presencePenalty: 0.0 })}
                        className="text-[10px] font-bold text-[var(--text-muted)] hover:text-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 border border-[var(--border-color)] px-2 py-0.5 rounded transition-all uppercase tracking-wider"
                    >
                        Reset Defaults
                    </button>
                </div>
