  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="relative inline-block">
        ...
        />
        <div 
          className="w-11 h-6 bg-[var(--color-background-secondary)] border border-[var(--color-border)] rounded-full peer peer-checked:bg-[var(--color-primary)] peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[var(--color-primary)]/50 transition-colors cursor-pointer"
