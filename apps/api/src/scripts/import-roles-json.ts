  ...
  for (const role of roles) {
    ...
    await prisma.role.upsert({
      ...
      update: {
        ...
        defaultStop: role.defaultStop ?? null,
        defaultSeed: role.defaultSeed ?? null,
        defaultResponseFormat: role.defaultResponseFormat ?? null,
        terminalRestrictions: role.terminalRestrictions ?? null,
        criteria: role.criteria ?? null,
        orchestrationConfig: role.orchestrationConfig ?? null,
        memoryConfig: role.memoryConfig ?? null,
