...
export async function logUsage(data) {
    ...
    const { modelConfigId, roleId, userId, usage, cost, ...metadata // This catches `router_metadata` or any other unknown fields
     } = data;
 ...
 */
export async function getBestModel(roleId) {
...
//# sourceMappingURL=modelManager.service.js.map