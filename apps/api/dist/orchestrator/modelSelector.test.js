...
import { loadModelCatalog, selectModel, HardStopError, RateLimitError, } from './modelSelector'; // Import the code to be tested
// --- 1. The "Hoisted" Mock ---
...
vi.mock('redis', () => {
    const MockRedisClient = {
        ...
        get: vi.fn((key) => mockRedisStore.get(key) || null),
        set: vi.fn((key, value) => mockRedisStore.set(key, value)),
        incr: vi.fn((key) => {
