...
import { initializeDatabase, createProvider, getAllProviders, getProviderById, updateProvider, saveModelsForProvider, } from './db/index.js';
    ...
    try {
        ...
        (async () => {
            try {
                ...
                console.error(`Failed to fetch and save models for new provider ${newProvider.id}:`, error.message);
            }
        })();
